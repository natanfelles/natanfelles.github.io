...
//
  var templates = {
    ...
    user_nav: Hogan.compile('<a href="#" class="icon-sprite icon-user dropdown-toggle" data-toggle="dropdown"></a><ul class="dropdown-menu"><li><a href="#user-info" data-toggle="modal"><i class="icon-user"></i>Ver detalhes da conta</a></li><li class="divider"></li><li><a href="https://twitter.com/{{screen_name}}" target="_blank"><i class="icon-share-alt"></i>Ver o perfil no Twitter</a></li></ul>'),
    modal_header: Hogan.compile('<h3>Detalhes da conta <span class="download-date muted">a partir de {{created_at_relative}}</span></h3>'),
    ...
    modal_account_details: Hogan.compile('<p>#{{id}} <span class="footer-label muted">ID do usuário</span></p><p class="truncated">{{created_at_relative}} <span class="footer-label muted">Entrou no Twitter</span></p>'),
...
//
  ...
  exports.init = function () {
    ...
    .bind('invalidSearch', function (e) {
      e.preventDefault();
      $(this)
        .attr('data-original-title', 'Sua consulta deve ter pelo menos dois caracteres.')
        .tooltip('show');
    });
  ...
  (function(exports) {
    exports.base = {
      init: function () {
        $('.navbar-search .search-query').attr('placeholder', 'Buscar todos os Tweets');
  ...
  (function (exports){
    ...
    exports.localizeStrings = function() {
      ...
      document.title = "Seu arquivo do Twitter";
      $('#footer-text').append("Este é um arquivo offline de seus Tweets do Twitter. Use os meses acima para navegar pelo arquivo.");
      var compose_new_tweet = "Publicar um novo Tweet";
